...
These thresholds are initial values for the submission. Conformal calibration (from `RomeoFlexVision/roboqc-dataset-preparation` reliability work) will refine these post-MVP.
